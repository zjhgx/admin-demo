...
public class MathScaleUtil {
	...
	/**
	 * 提供精确的2位小数位四舍五入处理，舍入模式采用ROUND_HALF_UP
	 * 
	 * @param b 需要四舍五入的数字
	 * @return 四舍五入后的结果
	 */
	
	public static BigDecimal round2bit(BigDecimal b) {
		 return b.setScale(2, BigDecimal.ROUND_HALF_UP);
	}
	
	/**
	 * 提供精确的4位小数位四舍五入处理，舍入模式采用ROUND_HALF_UP
	 * 
	 * @param b 需要四舍五入的数字
	 * @return 四舍五入后的结果
	 */
	public static BigDecimal round4bit(BigDecimal b) {
		 return b.setScale(4, BigDecimal.ROUND_HALF_UP);
	}
	/**
	 * 提供精确的6位小数位四舍五入处理，舍入模式采用ROUND_HALF_UP
	 * 
	 * @param b 需要四舍五入的数字
	 * @return 四舍五入后的结果
	 */
	public static BigDecimal round6bit(BigDecimal b) {
		 return b.setScale(6, BigDecimal.ROUND_HALF_UP);
	}
