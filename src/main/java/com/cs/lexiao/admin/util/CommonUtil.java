...
public class CommonUtil {
	 ...
	 *            the date string
	 * @param sepChar
	 *            a separate character in the date string such as '-' ':' or '/'
	 *            and so on
	...
	public static void main(String[] args) throws SecurityException,
		...
		//System.out.println(DateTimeUtil.getNowMillis());
		//System.out.println(DateTimeUtil.getNowSeconds());
	 ...
	 * @return
	 */
	public static List<Long> splitIdsToListLong(String source, String delim) {
		if (source == null || delim == null)
			return null;
		if (source.equals("") || delim.equals(""))
			return null;
