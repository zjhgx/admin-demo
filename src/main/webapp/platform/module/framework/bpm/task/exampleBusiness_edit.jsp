		...
		<form class="busi_form" id="exampleBusiness_addForm">
			<table>
				...
				<tbody>
					...
					<input type="hidden" name="eb.id" value="${eb.id}"/>
				</tbody>
			</table>
		</form>
	</tiles:putAttribute>
	<tiles:putAttribute name="button">
		<x:button iconCls="icon-edit" text="edit" click="doEdit" effect="round"/>
...
<script>
	function doEdit(){
		if($("#exampleBusiness_addForm").form("validate")){
			var url = '<s:url value="/bpm/exampleBusiness_edit.jhtml"/>';
