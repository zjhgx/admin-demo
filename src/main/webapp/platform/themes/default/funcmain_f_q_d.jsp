...
<link rel="stylesheet" type="text/css" href="<s:url value='/platform/themes/default/css/query.css'/>" />
<!-- 由此开始页面布局 -->
<div id="work_page"  class="easyui-layout" fit="true"  border="false">	
	...
	<div region="north" border="false" split="false" style="padding:0px;">
		<div class="easyui-layout" fit="true" border="false">
			...
			<div region="center" style="background:#fafafa;border:0px;border-top:1px solid #ccc;padding-top:2px;padding-left:2px;">
