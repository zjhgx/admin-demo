...
<div id="work_page"  class="easyui-layout" fit="true"  border="false">	
	...
	<div region="north" border="false" split="false" style="padding:0px;">
		<div class="easyui-layout" fit="true" border="false">
			<div border="false" split="false" style="padding:0px;margin:0px;border-bottom:1px solid #ccc;height:28px;" region="north">
				<tiles:insertAttribute name="flow"/>
			</div>
			<div region="center"  style="padding:0px;padding-top:1px;padding-left:2px;margin:0px;border:0px;border-bottom:1px solid #ccc;background:#efefef;width:100%;height:28px;" border="false" >
