...
<script language="javascript" src="<s:url value="/platform/static/plugins/lightbox/lightbox.min.js"/>"></script>
<!-- css  -->
...
<link rel="stylesheet" type="text/css" href="<s:url value="/platform/static/plugins/lightbox/css/lightbox.css"/>">
