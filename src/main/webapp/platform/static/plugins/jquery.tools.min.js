...
(function(a){
	...
	var b={
		...
		slide:function(a,b){
			this.getPanes().slideUp(0),
			this.getPanes().eq(a).slideDown(0,b);
		},
		ajax:function(a,b){
	...
	a.tools.tabs.addEffect("horizontal",function(b,d){
		...
		this.getCurrentPane().animate({width:0},function(){a(this).hide();}),
		this.getPanes().eq(b).animate({width:c},function(){a(this).show(),d.call();});
	});
	function d(c,d,e){
		var f=this,
		g=c.add(this),
		h=c.find(e.tabs),
		i=d.jquery?d:c.children(d),j;
