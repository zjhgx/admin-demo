...
_1b0.options.left=($(window).width()-_1b4)/2+$(document.documentElement).scrollLeft();
}
}
...
function _1e0(_1e1,_1e2,_1e3,param){
param = param || {};
...
var onCloseFunc = param.close;
win.window({title:_1e1,width:width,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
setTimeout(function(){
if (onCloseFunc) {
	onCloseFunc(false);
}
...
return win;
},confirm:function(_1e9,msg,fn,param){
param = param || {};
...
var win=_1e0(_1e9,_1ea,_1eb,param);
...
var isRight = true;
if($("body").width() < box.offset().left+box.outerWidth()+tip.outerWidth()/2){
	isRight=false;
}
if(isRight){
	...
	tip.css({display:"block",left:box.offset().left-tip.outerWidth(),top:box.offset().top});
}
};
function _309(_30c){
...
//shentu modified
var _331=$(".validatebox-invalid:first",_330);
if (_331.length) {
	formTabsValidate(_331);
}
_331.focus();
//
